...
python modules/eval/build_m04_rubric_template.py # M04 manual peer coding
```
...
- **Module 04:** qualitative C/A/W/U rubric on a peer sample (`eval/module_04/peer_relevance_rubric.csv`).

Model benchmark (5 pilot decks): `python modules/pipeline/model_selection.py`

Results land in `eval/module_02/`, `eval/module_03/`, `eval/module_04/`. The bundled `eval/` folder also contains **frozen summaries** from the thesis run.
